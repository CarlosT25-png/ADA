...
public class Guardar extends javax.swing.JFrame {
    ...
    private administrador.Administrador admin;
    private int tipo=0;
    ...
    public Guardar(alumno.Alumno est){
        tipo = 1;
        this.setUndecorated(true);
        initComponents();  
        this.est=est;
    ...
    public Guardar(profesor.Profesor prf){
        tipo=2;
        this.setUndecorated(true);
        initComponents();  
        this.prf=prf;
    ...
    public Guardar(administrador.Administrador admin){
        tipo=3;
        this.setUndecorated(true);
        initComponents();  
        this.admin=admin;
    ...
    private void initComponents() {
        ...
        btnGuardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagesAdmin/btnCrear.png"))); // NOI18N
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 200, -1, -1));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (tipo == 1) {
            ...
            if ((!txtCorreo.getText().equals("")) && (!txtPassword.getText().equals(""))) {
                admin.setEMAIL_INSTITUCION(txtCorreo.getText());
                admin.setCONTRASENA_SISTEMA(txtPassword.getText());

                try {
                    String consulta = "INSERT INTO PERSONAL VALUES(" + admin.getCIF() + ",'" + admin.getCOD_FACULTAD() + "','" + admin.getNOMBRE() + "','" + admin.getCEDULA() + "','" + admin.getDIRECCION()
                    + "','" + admin.getFECHA_NACIMIENTO() + "','" + admin.getEMAIL_INSTITUCION() + "','" + admin.getCONTRASENA_SISTEMA() + "')";
                ...
                try {
                    String consulta2 = "INSERT INTO PERSONAL_ADMINISTRATIVO VALUES(" + admin.getCIF() + ",'" + admin.getCARGO()+ "'," + admin.getSALARIO()+")";
                    PreparedStatement sql = Conexion.getConnection().prepareStatement(consulta2);
                ...
                if (alumno == true && facultad == true) {
                    JOptionPane.showMessageDialog(this, "El administrador " + admin.getNOMBRE() + " con CIF: " + admin.getCIF() + ", ha sido creado correctamente");
                    this.dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Error, no se pudo crear el profesor");
                }
